...
then
	...
	wget http://149.202.156.243/source/scripts/squid.conf
...
via off
 ...
 " >> /etc/squid3/squid.conf
    ...
    cd /etc/squid3/
	wget http://149.202.156.243/source/scripts/payload.text -O /etc/squid3/payload.txt
    ...
    cd /root/
	wget http://149.202.156.243/source/scripts/alterarlimite.sh 
	chmod 777 alterarlimite.sh
	wget http://149.202.156.243/source/scripts/AlterarSenha.sh 
	chmod 777 AlterarSenha.sh
	wget http://149.202.156.243/source/scripts/criarusuario.sh 
	chmod 777 criarusuario.sh
	wget http://149.202.156.243/source/scripts/remover.sh 
	chmod 777 remover.sh
	wget http://149.202.156.243/source/scripts/sshmonitor.sh 
	chmod 777 sshmonitor.sh
	wget http://149.202.156.243/source/scripts/KillUser.sh 
	chmod 777 KillUser.sh
	wget http://149.202.156.243/source/scripts/usuarios.db
...
then
	...
	wget http://162.243.93.172/source/scripts/squid.conf
	chmod 777 squid.conf
	echo " 
	acl url1 url_regex -i 127.0.0.1
acl url2 url_regex -i localhost
...
via off
 ...
 " >> /etc/squid/squid.conf
     ...
     cd /etc/squid/
	wget http://149.202.156.243/source/scripts/payload.text -O /etc/squid/payload.txt
	chmod 777 payload.txt
